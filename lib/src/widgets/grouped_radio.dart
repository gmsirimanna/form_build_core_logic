...
class _GroupedRadioState<T> extends State<GroupedRadio<T?>> {
  ...
  Widget buildItem(int index) {
    ...
    final control = Radio<T?>(
      ...
      value: optionValue,
      onChanged: isOptionDisabled ? null : (val) => widget.onChanged(optionValue),
    );
    ...
    if (widget.itemDecoration != null) {
      compositeItem = Container(
        ...
        margin: EdgeInsets.only(
          bottom: widget.orientation == OptionsOrientation.vertical ? widget.wrapSpacing : 0.0,
          right: widget.orientation == OptionsOrientation.horizontal ? widget.wrapSpacing : 0.0,
        ),
        child: compositeItem,
      );
    }
